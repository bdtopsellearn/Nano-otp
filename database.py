...
_DEFAULT_PANELS = [
    ("SMS Hadi",        "",   "",    "http://smshadi.net"),
    ("Konekta Premium", "",     "",   "https://konektapremium.net"),
    ("Msi sms",         "",       "",        "http://145.239.130.45/ints"),
    ("Number Panel",    "",     "",    "http://51.89.99.105/NumberPanel"),
    ("Purple sms",      "", "",  "http://85.195.94.50/sms"),
    ("Proof sms",       "",  "",   "http://217.182.195.194/ints"),
    ("Lamix sms",       "",  "",   "http://51.210.208.26/ints"),
    ("Seven 1 Tel",     "",     "",    "http://94.23.120.156/ints"),
    ("Flex sms",        "",   "",    "http://168.119.13.175/ints"),
    ("Zento sms",       "",  "",   "http://54.38.176.48/ints"),
    ("Wolf sms",        "",  "",   "http://213.32.24.208/ints"),
    ("Shark sms",       "",  "",   "http://65.109.111.158/ints"),
    ("SMS Hadi 2",      "",  "",   "http://smshadi.net"),
    ("KM Carrier sms",  "",  "",   "http://54.36.173.235/ints"),
]
...
def _init_db():
    ...
    _PANEL_MIGRATIONS = [
        ...
        ('SMS Hadi',  'http://185.2.83.39/ints',        'http://smshadi.net',           '',       ''),
        ('SMS Hadi',  'http://2.59.169.96/ints',        'http://smshadi.net',           '',       ''),
        ('Lamix sms', 'http://139.99.208.63/ints',      'http://51.210.208.26/ints',    '',       ''),
    ]
